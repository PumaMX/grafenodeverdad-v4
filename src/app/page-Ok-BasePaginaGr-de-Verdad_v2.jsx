...
<section id="hero" className="min-h-[70vh] flex items-center justify-center">
  <div className="w-full max-w-6xl mx-auto bg-white rounded-2xl shadow-lg grid md:grid-cols-2 gap-10 items-center px-8 py-16">
	...
	<div className="prose max-w-none text-gray-700">
        ...
        <p><strong>Servicios Integrales de Nanotecnología:</strong> Brindamos desarrollo de formulaciones, escalado industrial, certificación y pruebas estandarizadas (Raman, TEM, AFM, XPS), asegurando una integración confiable de nuestros materiales en procesos y productos de tus proyectos.</p>
