...
export default function Home() {
  return (
    <>
      {/* HERO */}
<section id="hero" className="pt-40 pb-20  flex items-center justify-center">
...
<p className="mb-2">
  ...
  {/* Columna derecha: Noticias Científicas */}
    <div className="fixed  top-[160px] right-4 h-[75vh] w-* max-w-[260px] bg-white border rounded-2xl p-4 overflow-y-auto shadow-lg z-40">
...
<li>
      <strong>Grafeno tridimensional (3D-Gr):</strong> estructuras porosas interconectadas con alta área superficial 
      y conductividad excepcional, ideales para almacenamiento de energía, catálisis, sensores y materiales 
      estructurales ultraligeros.
    </li>
    <li>
      <strong>Grafeno funcionalizado:</strong> modificado químicamente con diversos grupos funcionales para ajustar 
      propiedades eléctricas, mecánicas o químicas, facilitando su integración en matrices poliméricas, cerámicas 
      o metálicas.
    </li>
</ul>

<p className="pl-7 pt-4 text-gray-700">
    Las distintas morfologías y grados de funcionalización de nuestros materiales basados en grafeno nos brindan un 
    amplio portafolio de propiedades eléctricas, mecánicas, térmicas y ópticas. Esto nos permite diseñar soluciones 
    a la medida para sectores que van desde la electrónica avanzada y la energía, hasta los recubrimientos, blindajes 
    y compuestos estructurales de alto desempeño.
  </p>
<div className="h-4" /> {/* espacio vertical de 1rem ≈ 16px */}
  ...
  <Link href="/productos/tintas" className="block p-4 bg-white border rounded-2xl shadow hover:shadow-md">      
    ...
    <Link href="/productos/concreto-asfalto" className="p-4 bg-white border rounded-2xl shadow hover:shadow-md">
      ...
      <p className="text-sm mt-2">
	    ...
	    <Link href="/productos/antifouling" className="p-4 bg-white border rounded-2xl shadow hover:shadow-md">
    ...
    <Link href="/productos/biomedicina" className="p-4 bg-white border rounded-2xl shadow hover:shadow-md">
    ...
    <Link href="/productos/energia"  className="p-4 bg-white border rounded-2xl shadow hover:shadow-md">
      ...
      <section id="consultoria" className="py-16 bg-white rounded-2xl mx-auto max-w-6xl shadow-md mt-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center px-6">
          <div>
            ...
            <p className="text-sm">
                Con más de 25 años de experiencia en investigación y  desarrollo combinando conocimiento de campos interdisciplinarios, nuestro equipo ofrece consultoría especializada en nanotecnología y ciencia de materiales avanzados. Brindamos soluciones personalizadas que impulsan la innovación, optimizan procesos y fortalecen la competitividad industrial.
            </p>
          </div>
