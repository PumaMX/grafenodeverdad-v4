...
<section id="hero" className="min-h-[70vh] flex items-center justify-center">
  <div className="w-full max-w-6xl mx-auto bg-white rounded-2xl shadow-lg grid md:grid-cols-2 gap-10 items-center px-8 py-16">
    
    {/* Columna de texto */}
    <div>
      <h1 className="text-4xl font-extrabold text-gray-900 mb-6">Grafeno de Verdad</h1>
	<div className="prose max-w-none text-gray-700">
        <p><strong>Innovación en Grafeno y Materiales 2D:</strong> Ofrecemos formulaciones, su producción y caracterización de grafeno de alta calidad y certificado: desde grafeno CVD pristino y dopado con nitrógeno, hasta grafeno exfoliado en hojuelas de pocas capas (FGr) y óxido de grafeno (GO/rGO). Nuestros materiales están diseñados para aplicaciones de vanguardia y soluciones industriales diversas, incluyendo masterbatchs, fillers para polímeros, aditivos para concreto y asfalto, tintas funcionales, sensores y recubrimientos antifouling.</p>
        <p><strong>Productos de Alto Rendimiento:</strong> Disponemos de monocapas y multicapas de grafeno pristino y dopado con nitrógeno en distintos sustratos (Cu, Ni, Si/SiO2, PMMA, entre otros), formulaciones en polvo, dispersiones acuosas o en solventes, así como pastas con humedad controlada (20%-50%).</p>
        <p><strong>Servicios Integrales de Nanotecnología:</strong> Brindamos desarrollo de formulaciones, escalado industrial, certificación y pruebas estandarizadas (Raman, UV-Vis, SEM, HRTEM, TEM, AFM, XPS, TGA), asegurando una integración confiable de nuestros materiales en procesos y productos de tus proyectos.</p>
        <p><strong>Consultoría y Soluciones Estratégicas:</strong> Nuestro equipo de expertos con mas de 25 años de experiencia en investigación y desarrollo,  ofrece consultoría especializada en nanotecnología y ciencia de materiales nanoestructurados, proporcionando soluciones personalizadas que potencian la innovación y optimizan la competitividad industrial.</p>
      </div>
      <div className="mt-6 flex flex-wrap gap-4">
        <a href="#productos" className="px-4 py-2 border bg-gray-100 hover:bg-gray-200 text-black rounded">Ver Productos</a>
        <a href="#Proyectos" className="px-4 py-2 border bg-gray-100 hover:bg-gray-200 text-black rounded">Investigación + Desarrollo</a>
        <a href="#Consultoría" className="px-4 py-2 border bg-gray-100 hover:bg-gray-200 text-black rounded">Consultorías</a>
      </div>
    </div>
...
<section id="productos" className="py-16 bg-white rounded-2xl mx-auto max-w-6xl shadow-md mt-8">
  <h2 className="text-2xl font-bold mb-6">Productos y Aplicaciones</h2>
